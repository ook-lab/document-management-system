...
Generated: 2026-01-28T10:24:28.646122
Files: 32
...
- shared/pipeline/stage_g1_table_refiner.py (482 lines)
- shared/pipeline/stage_g2_text_refiner.py (463 lines)
...
- shared/pipeline/stage_h2_text.py (483 lines)
...
class StageG1TableRefiner:
    ...
    def __init__(self, llm_client=None):
        """
        Args:
            llm_client: LLMクライアント（オプション、複雑な表整形時に使用）
        """
        self.llm = llm_client

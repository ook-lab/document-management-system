...
Generated: 2026-01-28T11:35:41.123940
Files: 32
...
- shared/pipeline/stage_g1_table_refiner.py (691 lines)
...
class StageG1TableRefiner:
    ...
    def process(self, g1_input: Dict[str, Any]) -> Dict[str, Any]:
        ...
        for table in tables:
            ...
            # Step 3: AI研磨（必要な表のみ）
            if self._needs_ai_polish(table, validation):
                logger.info(f"[G1] AI研磨投入: {anchor_id}")

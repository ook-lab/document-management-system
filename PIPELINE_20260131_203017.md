...
Generated: 2026-01-31T20:30:17.194285
Files: 32
...
- shared/pipeline/stage_f_visual.py (4046 lines)
...
class StageFVisualAnalyzer:
    ...
    def _build_f7_prompt(self) -> str:
        ...
        【Ver 6.4】MAX_TOKENS対策: プロンプトを極限まで軽量化
        """
        return """# 文字読み取り（Ver 6.4）

黄色ラベル(#ID)の横の文字を読め。位置判断は不要。

## 出力
```json
{"texts":[["1","2/1"],["2","筑波大駒場"],["3","開成"]]}
```

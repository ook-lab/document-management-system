...
from dms.pipeline.stage_j_chunking import StageJChunking
from dms.pipeline.stage_k_embedding import StageKEmbedding
from dms.pipeline.config_loader import ConfigLoader

from dms.processing.state_manager import StateManager, get_state_manager
from dms.processing.resource_manager import AdaptiveResourceManager, get_cgroup_memory, get_cgroup_cpu
...
class PipelineManager:
    ...
    async def process_pipeline_meta_job(self, meta_id: str) -> bool:
        ...
        from dms.common.processing.metadata_chunker import MetadataChunker
    ...
    async def _process_pipeline_meta_gmail(
        ...
        from dms.pipeline.stage_g.g31_unified_writer import G31UnifiedWriter
        from dms.common.processing.metadata_chunker import MetadataChunker
        from dms.pipeline.stage_b.b26_gmail_text import B26GmailTextProcessor
        from dms.pipeline.stage_b.b27_gmail_html import B27GmailHTMLProcessor

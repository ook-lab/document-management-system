...
def main():
    ...
    # Use connection pooler address (IPv4)
    db_url = f"postgresql://postgres.hjkcgulxddtwlljhbocb:{db_password}@aws-0-ap-northeast-1.pooler.supabase.com:6543/postgres"

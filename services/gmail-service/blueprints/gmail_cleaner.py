...
REDIRECT_URI              = os.environ.get(
    ...
    'http://localhost:5010/gmail-cleaner/auth/callback',
)
...
"""
            ...
            try:
                ...
                log_ai_usage(
                    app='gmail-service', stage='gmail-cleaner-analyze', model=GEMINI_MODEL,

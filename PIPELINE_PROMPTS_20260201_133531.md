...
生成日時: 2026-02-01T13:35:31.942566
---
## サマリー
- プロンプト定義数: 9
- LLM呼び出し箇所: 12
...
### 9. stage_g1_table_refiner.py:428
- 使用プロンプト: `prompt`
...
読み取った文字のみ（説明不要）"""
            ...
            # 【Ver 6.6】G1 AIレスポンスログ出力
            logger.info(f"[G1] ===== 生成物ログ開始 =====")
```

### 10. stage_g2_text_refiner.py:437
- 使用プロンプト: `prompt`
...
読み取ったテキストのみ（説明不要）"""
            ...
            # 【Ver 6.6】G2 AIレスポンスログ出力
            logger.info(f"[G2] ===== 生成物ログ開始 =====")
```

...
from H_streamlit.utils.schema_detector import SchemaDetector
from H_streamlit.components.form_editor import render_form_editor
from H_streamlit.components.table_editor import render_table_editor, _render_array_table, _format_field_name
from H_streamlit.components.json_preview import render_json_preview, render_json_diff
    ...
    for key, value in metadata.items():
        ...
        if (key.endswith("_list") or key.endswith("_blocks") or
            ...
            if key == "extracted_tables":
                ...
                from H_streamlit.utils.table_parser import parse_extracted_tables
...
def pdf_review_ui():
            ...
            if file_path and Path(file_path).exists():
                ...
                # テキストファイルの場合（txt, md, csv, json, etc.）
                    ...
                    try:
                        ...
                        with text_tab2:
                            # 構造化表示
                            from H_streamlit.utils.text_structurer import TextStructurer
    ...
    with col_right:
        ...
        # 最後から2番目のタブ: 表を追加
        with tabs[-2]:
            from H_streamlit.components.table_creator import render_table_creator
...
def main():
    ...
    with tab2:
        # メールUIをインポートして表示
        from H_streamlit.email_inbox import email_inbox_ui
        email_inbox_ui()

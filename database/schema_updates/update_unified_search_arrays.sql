...
-- 【目的】: unified_search関数をpersons, organizations配列に対応
-- 【前提】: change_person_org_to_arrays.sqlを先に実行していること

BEGIN;

-- ============================================================
-- C1: 統一検索関数の更新（persons[], organizations[]対応）
-- ============================================================
...
COMMENT ON FUNCTION unified_search IS 'C1統一検索: persons[], organizations[], people[]対応、B2メタデータ重み付け対応、タイトルマッチ優先';

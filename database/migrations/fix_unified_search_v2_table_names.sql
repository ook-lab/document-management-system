...
-- 作成日: 2025-12-28
-- 目的: source_documents → Rawdata_FILE_AND_MAIL
...
BEGIN
    ...
    WITH chunk_scores AS (
        ...
        -- ✅ 修正: search_index → 10_ix_search_index
...
-- 実行後の確認用クエリ
-- =====================================================
-- テスト実行（embedding は既存のものを使用）
-- SELECT * FROM unified_search_v2(
--     'テスト',
--     (SELECT embedding FROM "10_ix_search_index" WHERE embedding IS NOT NULL LIMIT 1),
--     0.0,
--     5,
--     0.3,
--     0.7,
